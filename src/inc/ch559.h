...
SFR16LEX(UEP2_DMA,	0x244C);	// endpoint 2 buffer start address, little-endian
...
#ifndef NO_XSFR_DEFINE
SFR16LEX(UEP3_DMA,	0x244E);	// endpoint 3 buffer start address, little-endian
